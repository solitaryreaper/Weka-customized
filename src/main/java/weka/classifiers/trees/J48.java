...
public class J48 
  ...
  /**
   * Returns a set of rules corresponding to each path from root to leaf of the decision tree.
   * Each rule is of the form :
   * RULE	=>	IF <CLAUSE 1> AND <CLAUSE 2> AND .... <CLAUSE N> THEN LABEL
   * CLAUSE	=>	<FEATURE NAME> relop <VALUE>
   * 
   * @return List of string representations for each rule in the decision tree.
   * @author Shishir Kumar Prasad
   */
  public List<String> getDecisionTreeRules()
  {
	  String text = "";
	  List<String> ruleCollector = new ArrayList<String>();
	  m_root.collectTreeAsDecisionRules(0, text, ruleCollector);
